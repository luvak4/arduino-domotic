...
%	Il progetto viene sostanzialmente diviso in "funzioni": pulsantiera, display, attuatore.
    ...
    \subsection{Tabella mittenti/destinatari}
        ...
        \begin{tabular}{ll}
            \texttt{00000000 & tutti (broadcast)\\
            \texttt{00000001 & Pulsante per spegnimento PfSense\\
            \texttt{00000010 & Pulsante per riavvio PfSense\\
            \texttt{00000011 & Pulsante per ping tramite PfSense\\
            \texttt{00000100 & Pulsante sync scheda Arduino con PfSense\\
            \texttt{00000101 & Comunicazione che pfSense è ON\\
            \texttt{00000110 & Comunicazione che pfSense è in spegnimento\\            
            \texttt{00000111} & Comunicazione che pfSense è OFF\\            
            \texttt{00001000} & Comunicazione che pfSense è in riavvio\\            
            \texttt{00001001} & Comunicazione che pfSense non è connesso a internet\\            
            \texttt{00001010} & Comunicazione che pfSense è connesso a internet\\                   
            \texttt{00001011} & Pulsante accensione carico 01\\
            \texttt{00001011} & Pulsante spegnimento carico 01\\
        \end{tabular}
