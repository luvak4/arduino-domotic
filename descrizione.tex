...
\begin{document}
    ...
    \node[fill=yellow!10,minimum size=5.5cm] at (4.5,0){};
    
    \node[align=center,draw,minimum height=2cm,](a){display up};
    \node[align=center,minimum height=2cm,right =4cm of a,anchor=west, text width=1.5cm](b){keyboard (cambio indirizzi)};
    \node[align=center,draw,minimum height=4cm,right =of b,anchor=west, text width=1.5cm](c){display};
    \node[align=center,draw,above right =of c,anchor=south west, yshift=-1cm](d){FW firewall};    
    \node[align=center,draw,below=2mm of d,anchor=north](e){NA NAS};
    \node[align=center,draw,below=2mm of e,anchor=north](f){CA cantina};
    \node[align=center,draw,below=2mm of f,anchor=north](g){GA garage};
    \node[align=center,draw,below=2mm of g,anchor=north](h){TR termostato};
    \node[align=center,draw,below=2mm of h,anchor=north](i){CO compasso};
    \node[align=center,draw,below=2mm of i,anchor=north](j){TE tetto};
    
    \node[align=center,draw,left=6cm of d,anchor=east](dd){FWr firewall};    
    \node[align=center,draw,below=2mm of dd,anchor=north](ee){NAr NAS};
    \node[align=center,draw,below=2mm of ee,anchor=north](ff){CAr cantina};
    \node[align=center,draw,below=2mm of ff,anchor=north](gg){GAr garage};
    \node[align=center,draw,below=2mm of gg,anchor=north](hh){TRr termostato};
    \node[align=center,draw,below=2mm of hh,anchor=north](ii){COr compasso};
    \node[align=center,draw,below=2mm of ii,anchor=north](jj){TEr tetto};
    
    
    \node[right=1.2cm of a](x){};
    \draw[-latex] (x) -- node[midway,above]{TX} (a);

    \draw[latex-,ultra thick] (b) -- node[midway,above]{seriale} (c);
    \draw[latex-] (c) -- (d.west);
    \draw[latex-] (c) -- (e.west);
    \draw[latex-] (c) -- (f.west);
    \draw[latex-] (c) -- (g.west);
    ...
    \section{Identificativi Tx e sensibilità nominativi Rx}
