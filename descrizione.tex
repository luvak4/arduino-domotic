...
\begin{document}
    ...
    \begin{tabular}{lll}
        ...
        \texttt{pulsACTU0001} & imposta Rele ON & 		 \texttt{\RGPx{AB}{01}}\\
        \texttt{pulsACTU0002} & imposta Rele OFF & 	 	 \texttt{\RGPx{AB}{02}}\\
        \texttt{pulsACTU0003} & leggi stato rele & 	 	 \texttt{\RGPx{AB}{03}}\\
        \texttt{pulsACTU0004} & leggi analogico A0 & 	 \texttt{\RGP{AB}{04}{00}{00}{00}{00}}\\            
        ...
        \texttt{statPFSE0007} & ricevuto comando & 	 \texttt{\RGPx{AC}{08}}\\
        ...
        \texttt{statACTU0007} & ricevuto comando & 		 \texttt{\RGPx{AD}{04}}\\                
    \end{tabular}
